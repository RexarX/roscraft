...
#include <roscraft/memory/free_list_allocator.hpp>
...
TEST_SUITE("memory::FreeListAllocator") {
  TEST_CASE("memory::FreeListAllocator::ctor(FreeListAllocatorOptions)") {
  ...
  TEST_CASE("memory::FreeListAllocator::ctor(size_t)") {
  ...
  TEST_CASE("memory::FreeListAllocator::ctor(FreeListAllocator&&)") {
  ...
  TEST_CASE("memory::FreeListAllocator::operator=(FreeListAllocator&&)") {
  ...
  TEST_CASE("memory::FreeListAllocator::Reset") {
  ...
  TEST_CASE("memory::FreeListAllocator::Empty") {
  ...
  TEST_CASE("memory::FreeListAllocator::Owns") {
  ...
  TEST_CASE("memory::FreeListAllocator::Stats") {
  ...
  TEST_CASE("memory::FreeListAllocator::Capacity") {
  ...
  TEST_CASE("memory::FreeListAllocator::UsedMemory") {
  ...
  TEST_CASE("memory::FreeListAllocator::FreeMemory") {
  ...
  TEST_CASE("memory::FreeListAllocator::FreeBlockCount") {
  ...
  TEST_CASE("memory::FreeListAllocator::AllocationCount") {
    SUBCASE("Is zero on fresh allocator") {
      const FreeListAllocator alloc(kMinCap);
      CHECK_EQ(alloc.AllocationCount(), 0);
    }
  ...
  TEST_CASE("memory::FreeListAllocator::Growth") {
  ...
  TEST_CASE("memory::FreeListAllocator::allocate") {
  ...
  TEST_CASE("memory::FreeListAllocator::deallocate") {
  ...
  TEST_CASE("memory::FreeListAllocator thread-safety: concurrent allocate") {
  ...
  TEST_CASE(
      "memory::FreeListAllocator thread-safety: concurrent alloc+dealloc") {
