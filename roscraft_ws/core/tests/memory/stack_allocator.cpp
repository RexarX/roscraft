...
#include <roscraft/memory/stack_allocator.hpp>
...
TEST_SUITE("memory::StackAllocator") {
  TEST_CASE("memory::StackAllocator::ctor(StackAllocatorOptions)") {
  ...
  TEST_CASE("memory::StackAllocator::ctor(size_t)") {
  ...
  TEST_CASE("memory::StackAllocator::ctor(StackAllocator&&)") {
  ...
  TEST_CASE("memory::StackAllocator::operator=(StackAllocator&&)") {
  ...
  TEST_CASE("memory::StackAllocator::GetMarker") {
  ...
  TEST_CASE("memory::StackAllocator::Reset") {
  ...
  TEST_CASE("memory::StackAllocator::Empty") {
  ...
  TEST_CASE("memory::StackAllocator::Stats") {
  ...
  TEST_CASE("memory::StackAllocator::InitialCapacity") {
  ...
  TEST_CASE("memory::StackAllocator::TotalCapacity") {
  ...
  TEST_CASE("memory::StackAllocator::BlockCount") {
  ...
  TEST_CASE("memory::StackAllocator::Growth") {
  ...
  TEST_CASE("memory::StackAllocator::allocate") {
  ...
  TEST_CASE("memory::StackAllocator::deallocate") {
    SUBCASE(
  ...
  TEST_CASE("memory::StackAllocator thread-safety: concurrent allocate") {
  ...
  TEST_CASE("memory::StackAllocator thread-safety: concurrent deallocate") {
