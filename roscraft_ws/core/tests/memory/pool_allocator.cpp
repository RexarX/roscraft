...
#include <roscraft/memory/pool_allocator.hpp>
...
TEST_SUITE("memory::PoolAllocator") {
  TEST_CASE("memory::PoolAllocator::ctor(PoolAllocatorOptions)") {
  ...
  TEST_CASE("memory::PoolAllocator::ctor(size_t, size_t, size_t)") {
  ...
  TEST_CASE("memory::PoolAllocator::ForType") {
  ...
  TEST_CASE("memory::PoolAllocator::operator=(PoolAllocator&&)") {
    ...
    SUBCASE("Self move assignment does not corrupt state") {
      ...
      pool.allocate(kBlockSize, kAlign);
  ...
  TEST_CASE("memory::PoolAllocator::Reset") {
  ...
  TEST_CASE("memory::PoolAllocator::Full") {
  ...
  TEST_CASE("memory::PoolAllocator::Empty") {
  ...
  TEST_CASE("memory::PoolAllocator::Owns") {
  ...
  TEST_CASE("memory::PoolAllocator::Stats") {
  ...
  TEST_CASE("memory::PoolAllocator::BlockSize") {
  ...
  TEST_CASE("memory::PoolAllocator::Alignment") {
  ...
  TEST_CASE("memory::PoolAllocator::InitialBlockCount") {
  ...
  TEST_CASE("memory::PoolAllocator::BlockCount") {
  ...
  TEST_CASE("memory::PoolAllocator::FreeBlockCount") {
  ...
  TEST_CASE("memory::PoolAllocator::UsedBlockCount") {
  ...
  TEST_CASE("memory::PoolAllocator::Growth") {
  ...
  // ── allocate (PMR do_allocate) ───────────────────────────────────────────

  TEST_CASE("memory::PoolAllocator::allocate") {
  ...
  TEST_CASE("memory::PoolAllocator::deallocate") {
  ...
  TEST_CASE("memory::PoolAllocator thread-safety: concurrent allocate") {
  ...
  TEST_CASE("memory::PoolAllocator thread-safety: concurrent alloc+dealloc") {
