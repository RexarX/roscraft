...
struct CountingStorage {
  ...
  explicit CountingStorage(int v) : value(v) { ++construct_count; }
  CountingStorage(const CountingStorage& o) : value(o.value) {
    ++construct_count;
  }
  CountingStorage(CountingStorage&& o) noexcept : value(o.value) {
    ++construct_count;
  }
