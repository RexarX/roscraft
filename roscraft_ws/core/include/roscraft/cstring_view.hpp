...
constexpr auto BasicCStringView<CharT, Traits>::Copy(
  ...
  ROSCRAFT_ASSERT(pos < Size(), "pos out of bounds!");
...
constexpr auto BasicCStringView<CharT, Traits>::operator[](
  ...
  ROSCRAFT_ASSERT(pos < Size(), "index out of bounds!");
  return data_[pos];
}
 ...
 */
template <typename CharT, typename Traits>
struct hash<roscraft::BasicCStringView<CharT, Traits>> {
  [[nodiscard]] constexpr size_t operator()(
      const roscraft::BasicCStringView<CharT, Traits>& str) const noexcept {
 ...
 */
template <typename CharT, typename Traits>
struct formatter<roscraft::BasicCStringView<CharT, Traits>>
  ...
  auto format(const roscraft::BasicCStringView<CharT, Traits>& str,
