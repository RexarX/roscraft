...
#define ROSCRAFT_API __declspec(dllexport)
#else
#define ROSCRAFT_API __declspec(dllimport)
#endif
#elifdef ROSCRAFT_PLATFORM_LINUX
#ifdef ROSCRAFT_BUILD_SHARED
#define ROSCRAFT_API __attribute__((visibility("default")))
#else
#define ROSCRAFT_API
#endif
#else
...
#ifdef ROSCRAFT_PLATFORM_WINDOWS
#define ROSCRAFT_EXPORT __declspec(dllexport)
#elifdef ROSCRAFT_PLATFORM_LINUX
#define ROSCRAFT_EXPORT __attribute__((visibility("default")))
#else
#define ROSCRAFT_EXPORT
#endif
...
#else
#include <csignal>
#define ROSCRAFT_DEBUG_BREAK() ::std::raise(SIGTRAP)
#endif
