# CPM (CMake Package Manager) integration for Roscraft
...
macro(roscraft_cpm_add_package)
    ...
    if(NOT CPM_ARG_NAME)
        message(FATAL_ERROR "roscraft_cpm_add_package: NAME is required")
    endif()
    ...
    if(${CPM_ARG_NAME}_ADDED)
        ...
        # Note: SYSTEM marking is deferred - use roscraft_cpm_mark_as_system() function
...
function(roscraft_print_cpm_packages)
    if(CPM_PACKAGES)
...
function(roscraft_cpm_add_github_package)
    set(options)
    ...
    if(NOT ARG_NAME OR NOT ARG_REPOSITORY)
        message(FATAL_ERROR "roscraft_cpm_add_github_package: NAME and REPOSITORY are required")
    endif()
