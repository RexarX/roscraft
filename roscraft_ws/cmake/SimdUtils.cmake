...
function(roscraft_simd_build_flag_lists LEVEL OUT_GNU_FLAGS OUT_MSVC_FLAGS)
    set(_gnu "")
    set(_msvc "")
...
function(roscraft_simd_filter_supported_flags FLAGS_LIST_VAR OUT_VAR)
...
function(roscraft_simd_apply_to_target)
    ...
    if(NOT SIMD_TARGET)
        message(FATAL_ERROR "roscraft_simd_apply_to_target: TARGET is required")
    endif()
    ...
    # Build flag lists
    roscraft_simd_build_flag_lists("${_level}" _gnu_flags _msvc_flags)

    # Filter to supported flags
    roscraft_simd_filter_supported_flags(_gnu_flags _gnu_accepted)
    roscraft_simd_filter_supported_flags(_msvc_flags _msvc_accepted)
...
# Usage:
#   roscraft_simd_create_interface_libs()
#   target_link_libraries(mytarget PRIVATE simd::avx2)
function(roscraft_simd_create_interface_libs)
    ...
    foreach(_lvl IN LISTS _levels)
        ...
        # Get flags
        roscraft_simd_build_flag_lists("${_lvl}" _g _m)
        roscraft_simd_filter_supported_flags(_g _g_ok)
        roscraft_simd_filter_supported_flags(_m _m_ok)
...
function(roscraft_simd_known_levels OUT_VAR)
    set(_levels "none" "native" "sse2" "sse3" "ssse3" "sse4.1" "sse4.2" "avx" "avx2" "avx512")
