...
function(roscraft_target_set_warnings TARGET)
    set(MSVC_WARNINGS
...
function(roscraft_target_set_optimization TARGET)
    target_compile_options(${TARGET} PRIVATE
...
function(roscraft_target_set_platform TARGET)
    target_compile_definitions(${TARGET} PUBLIC
        $<$<PLATFORM_ID:Windows>:ROSCRAFT_PLATFORM_WINDOWS>
        $<$<PLATFORM_ID:Linux>:ROSCRAFT_PLATFORM_LINUX>
        $<$<PLATFORM_ID:Darwin>:ROSCRAFT_PLATFORM_MACOS>
        $<$<CONFIG:Debug>:ROSCRAFT_DEBUG_MODE>
        $<$<CONFIG:RelWithDebInfo>:ROSCRAFT_RELEASE_WITH_DEBUG_INFO_MODE>
        $<$<CONFIG:Release>:ROSCRAFT_RELEASE_MODE NDEBUG>
    )
...
function(roscraft_target_set_shared_lib_platform TARGET)
    if(WIN32 AND MSVC)
        set_target_properties(${TARGET} PROPERTIES
...
function(roscraft_target_set_output_dirs TARGET)
...
function(roscraft_target_set_cxx_standard TARGET)
...
function(roscraft_target_set_folder TARGET FOLDER_NAME)
...
function(roscraft_target_enable_unity_build TARGET)
...
function(roscraft_target_add_pch TARGET PCH_FILE)
...
function(roscraft_target_mark_dependencies_as_system TARGET)
...
# Usage: roscraft_target_link_system_libraries(my_target PUBLIC external::lib1 external::lib2)
function(roscraft_target_link_system_libraries TARGET VISIBILITY)
...
# Usage: roscraft_copy_runtime_dependencies(my_target LIBRARIES lib1 lib2...)
function(roscraft_copy_runtime_dependencies TARGET)
