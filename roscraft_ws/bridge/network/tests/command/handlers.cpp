...
flatbuffers::FlatBufferBuilder BuildInterfaceListPacket(uint64_t request_id,
...
flatbuffers::FlatBufferBuilder BuildTopicHzPacket(uint64_t request_id,
                                                  ...
                                                  uint32_t window) {
  flatbuffers::FlatBufferBuilder fbb;
  const auto inner = fbs::CreateTopicHzPacket(
      fbb, request_id, fbb.CreateString(topic_name.data(), topic_name.size()),
      fbb.CreateString(message_type.data(), message_type.size()), window);
  static_cast<void>(
      BuildBridgePacket(fbb, inner.Union(), fbs::PacketPayload::TopicHzPacket));
  return fbb;
}
...
flatbuffers::FlatBufferBuilder BuildTopicBwPacket(uint64_t request_id,
                                                  ...
                                                  uint32_t window) {
  flatbuffers::FlatBufferBuilder fbb;
  const auto inner = fbs::CreateTopicBwPacket(
      fbb, request_id, fbb.CreateString(topic_name.data(), topic_name.size()),
      fbb.CreateString(message_type.data(), message_type.size()), window);
  static_cast<void>(
      BuildBridgePacket(fbb, inner.Union(), fbs::PacketPayload::TopicBwPacket));
  return fbb;
}
...
TEST_SUITE("bridge::network::command::handlers") {
  ...
  TEST_CASE("bridge::network::GraphHandler::DrainAndSend") {
    ...
    REQUIRE(first_payload->services() != nullptr);
    REQUIRE(first_payload->services()->size() == 1U);
    CHECK_EQ(first_payload->services()->Get(0)->name()->string_view(),
             "/service/one");
    CHECK_EQ(first_payload->services()->Get(0)->type()->string_view(),
             "std_srvs/srv/Empty");

    REQUIRE(first_payload->actions() != nullptr);
    REQUIRE(first_payload->actions()->size() == 1U);
    CHECK_EQ(first_payload->actions()->Get(0)->name()->string_view(),
             "/action/one");
    CHECK_EQ(first_payload->actions()->Get(0)->type()->string_view(),
  ...
  TEST_CASE("bridge::network::NodeInfoHandler::Receive") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
  ...
  TEST_CASE("bridge::network::NodeInfoHandler::DrainAndSend") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
  ...
  TEST_CASE("bridge::network::NodeInfoHandler::From") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
  ...
  TEST_CASE("bridge::network::TopicInfoHandler::Receive") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
  ...
  TEST_CASE("bridge::network::TopicInfoHandler::DrainAndSend") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
  ...
  TEST_CASE("bridge::network::TopicInfoHandler::From") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
  ...
  TEST_CASE("bridge::network::ServiceInfoHandler::Receive") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
  ...
  TEST_CASE("bridge::network::ServiceInfoHandler::DrainAndSend") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
  ...
  TEST_CASE("bridge::network::ServiceInfoHandler::From") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
  ...
  TEST_CASE("bridge::network::InterfaceListHandler::Receive") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);

    InterfaceListHandler handler =
        InterfaceListHandler::From(incoming, outgoing);
    std::pmr::monotonic_buffer_resource arena;
  ...
  TEST_CASE("bridge::network::InterfaceListHandler::DrainAndSend") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
  ...
  TEST_CASE("bridge::network::InterfaceListHandler::From") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
  ...
  TEST_CASE("bridge::network::InterfaceShowHandler::Receive") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
  ...
  TEST_CASE("bridge::network::InterfaceShowHandler::DrainAndSend") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
  ...
  TEST_CASE("bridge::network::InterfaceShowHandler::From") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
  ...
  TEST_CASE("bridge::network::SubscribeTopicHandler::Receive") {
    ...
    auto packet_fbb = BuildSubscribeTopicPacket(
        121U, "/topic/sub", "std_msgs/msg/String", true, 3.5, true);
    const auto* packet = fbs::GetBridgePacket(packet_fbb.GetBufferPointer());
  ...
  TEST_CASE("bridge::network::TopicHzHandler::Receive") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
    ...
    auto packet_fbb =
        BuildTopicHzPacket(301U, "/topic/hz", "std_msgs/msg/String", 20U);
    const auto* packet = fbs::GetBridgePacket(packet_fbb.GetBufferPointer());
  ...
  TEST_CASE("bridge::network::TopicHzHandler::DrainAndSend") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
    ...
    const auto datagram = TryReceiveDatagram(receiver);
    REQUIRE(datagram.has_value());
    const auto* pkt = ParseBridgePacket(*datagram);
    REQUIRE(pkt != nullptr);
    CHECK_EQ(pkt->payload_type(), fbs::PacketPayload::TopicHzResponsePacket);
  ...
  TEST_CASE("bridge::network::TopicHzHandler::From") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
  ...
  TEST_CASE("bridge::network::TopicBwHandler::Receive") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
    ...
    auto packet_fbb =
        BuildTopicBwPacket(401U, "/topic/bw", "sensor_msgs/msg/Image", 30U);
    const auto* packet = fbs::GetBridgePacket(packet_fbb.GetBufferPointer());
  ...
  TEST_CASE("bridge::network::TopicBwHandler::DrainAndSend") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
    ...
    const auto* pkt = ParseBridgePacket(*datagram);
    REQUIRE(pkt != nullptr);
    CHECK_EQ(pkt->payload_type(), fbs::PacketPayload::TopicBwResponsePacket);
  ...
  TEST_CASE("bridge::network::TopicBwHandler::From") {
    CommandQueue incoming;
    CommandQueue outgoing;
    RegisterIncomingQueueTypes(incoming);
    RegisterOutgoingQueueTypes(outgoing);
  ...
  TEST_CASE("bridge::network::TopicPayloadHandler::DrainAndSend") {
    ...
    REQUIRE(payload_packet != nullptr);
    CHECK_EQ(payload_packet->request_id(), 333U);
  ...
  TEST_CASE("bridge::network::DispatchReceive") {
    ...
    auto topic_hz_fbb =
        BuildTopicHzPacket(210U, "/dispatch/hz", "std_msgs/msg/Int32", 25U);
    auto topic_bw_fbb =
        BuildTopicBwPacket(211U, "/dispatch/bw", "sensor_msgs/msg/Image", 30U);
  ...
  TEST_CASE("bridge::network::ErrorHandler::DrainAndSend") {
    CommandQueue outgoing;
    RegisterOutgoingQueueTypes(outgoing);

    ErrorHandler handler = ErrorHandler::From(outgoing);
    ...
    CHECK_EQ(error_packet->request_id(), 500U);
    CHECK_EQ(error_packet->error_code()->string_view(), "SUBSCRIBE_FAILED");
    CHECK_EQ(error_packet->error_message()->string_view(),
  ...
  TEST_CASE("bridge::network::ErrorHandler::From") {
    CommandQueue outgoing;
    RegisterOutgoingQueueTypes(outgoing);
