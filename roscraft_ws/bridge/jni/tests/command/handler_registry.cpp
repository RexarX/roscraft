...
TEST_SUITE("bridge::jni::CommandHandlerRegistry") {
  TEST_CASE("bridge::jni::CommandHandlerRegistry::ctor") {
  ...
  TEST_CASE("bridge::jni::CommandHandlerRegistry::Clear") {
    CommandHandlerRegistry registry;
  ...
  TEST_CASE("bridge::jni::CommandHandlerRegistry::AddHandler") {
    CommandHandlerRegistry registry;
    CommandQueue queue;
    ...
    registry.DrainAndDeliver<RegistryDrainHandlerA>(queue, nullptr, callback,
                                                    fbb);
  ...
  TEST_CASE("bridge::jni::CommandHandlerRegistry::TryAddHandler") {
    CommandHandlerRegistry registry;
    CommandQueue queue;
    BridgeCallback callback;
    flatbuffers::FlatBufferBuilder fbb;
  ...
  TEST_CASE("bridge::jni::CommandHandlerRegistry::EmplaceHandler") {
    CommandHandlerRegistry registry;
  ...
  TEST_CASE("bridge::jni::CommandHandlerRegistry::TryEmplaceHandler") {
    CommandHandlerRegistry registry;
  ...
  TEST_CASE("bridge::jni::CommandHandlerRegistry::RemoveHandler") {
    CommandHandlerRegistry registry;
  ...
  TEST_CASE("bridge::jni::CommandHandlerRegistry::TryRemoveHandler") {
    CommandHandlerRegistry registry;
  ...
  TEST_CASE("bridge::jni::CommandHandlerRegistry::DrainAndDeliverAll<TupleT>") {
    CommandHandlerRegistry registry;
    CommandQueue queue;
    BridgeCallback callback;
    flatbuffers::FlatBufferBuilder fbb;
    ...
    registry.DrainAndDeliverAll<
        std::tuple<RegistryDrainHandlerA, RegistryDrainHandlerB>>(
        queue, nullptr, callback, fbb);

    CHECK_EQ(calls_a, 1);
    CHECK_EQ(calls_b, 1);
  }

  TEST_CASE("bridge::jni::CommandHandlerRegistry::DrainAndDeliverAll<Ts...>") {
    CommandHandlerRegistry registry;
    CommandQueue queue;
    BridgeCallback callback;
    flatbuffers::FlatBufferBuilder fbb;
    ...
    registry.DrainAndDeliverAll<RegistryDrainHandlerA, RegistryDrainHandlerB>(
        queue, nullptr, callback, fbb);
  ...
  TEST_CASE("bridge::jni::CommandHandlerRegistry::DrainAndDeliver") {
    CommandHandlerRegistry registry;
    CommandQueue queue;
    BridgeCallback callback;
    flatbuffers::FlatBufferBuilder fbb;
  ...
  TEST_CASE("bridge::jni::CommandHandlerRegistry::DrainAndDeliverIfExists") {
    CommandHandlerRegistry registry;
    CommandQueue queue;
    BridgeCallback callback;
    flatbuffers::FlatBufferBuilder fbb;
    ...
    registry.DrainAndDeliverIfExists<RegistryDrainHandlerA>(queue, nullptr,
                                                            callback, fbb);
    CHECK_EQ(calls, 0);
  ...
  TEST_CASE("bridge::jni::CommandHandlerRegistry::Receive") {
    CommandHandlerRegistry registry;
    CommandQueue queue;
  ...
  TEST_CASE("bridge::jni::CommandHandlerRegistry::Contains") {
    CommandHandlerRegistry registry;
  ...
  TEST_CASE("bridge::jni::CommandHandlerRegistry::Empty") {
    CommandHandlerRegistry registry;
  ...
  TEST_CASE("bridge::jni::CommandHandlerRegistry::Size") {
    CommandHandlerRegistry registry;
