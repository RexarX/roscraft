...
inline void NodeInfoHandler::DrainAndDeliver(
  ...
  while (storage.Dequeue(out_consumer, cmd)) {
    ...
    const auto payload = builder.Finish();
    const auto root = fbs::CreateBridgePacket(
        fbb, fbs::PacketPayload::NodeInfoResponsePacket, payload.Union());
    fbs::FinishBridgePacketBuffer(fbb, root);
...
inline void TopicInfoHandler::DrainAndDeliver(
    CommandQueue& out, JNIEnv* env, const BridgeCallback& callback,
    flatbuffers::FlatBufferBuilder& fbb) {
  ...
  while (storage.Dequeue(out_consumer, cmd)) {
    ...
    const auto payload = builder.Finish();
    const auto root = fbs::CreateBridgePacket(
        fbb, fbs::PacketPayload::TopicInfoResponsePacket, payload.Union());
    fbs::FinishBridgePacketBuffer(fbb, root);
...
inline void ServiceInfoHandler::DrainAndDeliver(
    CommandQueue& out, JNIEnv* env, const BridgeCallback& callback,
    flatbuffers::FlatBufferBuilder& fbb) {
  ...
  while (storage.Dequeue(out_consumer, cmd)) {
    ...
    const auto payload = builder.Finish();
    const auto root = fbs::CreateBridgePacket(
        fbb, fbs::PacketPayload::ServiceInfoResponsePacket, payload.Union());
    fbs::FinishBridgePacketBuffer(fbb, root);
...
inline void InterfaceListHandler::DrainAndDeliver(
    CommandQueue& out, JNIEnv* env, const BridgeCallback& callback,
    flatbuffers::FlatBufferBuilder& fbb) {
  ...
  while (storage.Dequeue(out_consumer, cmd)) {
    ...
    const auto payload = builder.Finish();
    const auto root = fbs::CreateBridgePacket(
        fbb, fbs::PacketPayload::InterfaceListResponsePacket, payload.Union());
    fbs::FinishBridgePacketBuffer(fbb, root);
...
inline void InterfaceShowHandler::DrainAndDeliver(
    CommandQueue& out, JNIEnv* env, const BridgeCallback& callback,
    flatbuffers::FlatBufferBuilder& fbb) {
  ...
  while (storage.Dequeue(out_consumer, cmd)) {
    ...
    const auto payload = builder.Finish();
    const auto root = fbs::CreateBridgePacket(
        fbb, fbs::PacketPayload::InterfaceShowResponsePacket, payload.Union());
    fbs::FinishBridgePacketBuffer(fbb, root);
...
inline void TopicHzHandler::DrainAndDeliver(
    CommandQueue& out, JNIEnv* env, const BridgeCallback& callback,
    flatbuffers::FlatBufferBuilder& fbb) {
  ...
  while (storage.Dequeue(out_consumer, cmd)) {
    ...
    const auto payload = builder.Finish();
    const auto root = fbs::CreateBridgePacket(
        fbb, fbs::PacketPayload::TopicHzResponsePacket, payload.Union());
    fbs::FinishBridgePacketBuffer(fbb, root);
...
inline void TopicBwHandler::DrainAndDeliver(
    CommandQueue& out, JNIEnv* env, const BridgeCallback& callback,
    flatbuffers::FlatBufferBuilder& fbb) {
  ...
  while (storage.Dequeue(out_consumer, cmd)) {
    ...
    const auto payload = builder.Finish();
    const auto root = fbs::CreateBridgePacket(
        fbb, fbs::PacketPayload::TopicBwResponsePacket, payload.Union());
    fbs::FinishBridgePacketBuffer(fbb, root);
...
inline void ErrorHandler::DrainAndDeliver(CommandQueue& out, JNIEnv* env,
                                          const BridgeCallback& callback,
                                          flatbuffers::FlatBufferBuilder& fbb) {
